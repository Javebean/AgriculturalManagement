...
<body>
	...
	<div id="main_navigation" class="dark_navigation">
			...
			<ul class="main">
				...
				<li>
				<a href="caiji.jsp" target="right" onClick="getclassname(this)"><i class="icon-filter"></i>&nbsp;&nbsp;采集</a>
				</li>
								<li>
				<a href="qdzhdd.jsp" target="right" onClick="getclassname(this)"><i class="icon-pencil"></i>&nbsp;&nbsp;启动指挥调度</a>
				</li>
					<li>
				<a href="ddcl.jsp" target="right" onClick="getclassname(this)"><i class="icon-flag"></i>&nbsp;&nbsp;调度处理</a>
				</li>
								<li>
				<a href="yxzlc.jsp" target="right" onClick="getclassname(this)"><i class="icon-fire"></i>&nbsp;&nbsp;运行中流程</a>
				</li>
				<li>
				<a href="yjslc.jsp" target="right" onClick="getclassname(this)"><i class="icon-ok-sign"></i>&nbsp;&nbsp;已结束流程</a>
				</li>
			</ul>
